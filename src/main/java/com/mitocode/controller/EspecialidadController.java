...
public class EspecialidadController {
	...
	@PostMapping
	public ResponseEntity<Especialidad> registrar(@Valid @RequestBody Especialidad espec) throws Exception{
		Especialidad obj = service.registrar(espec);
	...
	@PutMapping
	public ResponseEntity<Especialidad> modificar(@Valid @RequestBody Especialidad espec) throws Exception{
		Especialidad obj = service.modificar(espec);
		return new ResponseEntity<Especialidad>(obj, HttpStatus.OK);
	}
