...
public class SignosController {
	...
	@PostMapping
	public ResponseEntity<Void> registrar(@Valid @RequestBody Signos sig) throws Exception{
	...
	@PutMapping
	public ResponseEntity<Signos> modificar(@Valid @RequestBody Signos sig) throws Exception{
		Signos obj = service.modificar(sig);
		return new ResponseEntity<Signos>(obj, HttpStatus.OK);
	}
