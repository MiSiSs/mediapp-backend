...
public class MedicoController {
	...
	@PostMapping
	public ResponseEntity<Void> registrar(@Valid @RequestBody Medico medic) throws Exception{
		Medico obj = service.registrar(medic);
	...
	@PutMapping
	public ResponseEntity<Medico> modificar(@Valid @RequestBody Medico medic) throws Exception{
		Medico obj = service.modificar(medic);
		return new ResponseEntity<Medico>(obj, HttpStatus.OK);
	}
